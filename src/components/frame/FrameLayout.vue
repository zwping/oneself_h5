        ...
        <a-menu mode="inline">
          ...
          <a-sub-menu key="2">
            ...
            <a-menu-item-group key="2-3">
              <template slot="title"><span>Tool</span></template>
              <a-menu-item key="2-3-1" @click="fc_tabs">分类</a-menu-item>
              <a-menu-item key="2-3-2" @click="fc_tabs">日志</a-menu-item>
            </a-menu-item-group>
          </a-sub-menu>
          <a-sub-menu key="3">
            <span slot="title">
  ...
  export default {
    ...
    methods: {
      fc_tabs(e) {
        ...
        emit('fc_tabs', {title: n, content: comp, key: n, clo: true, api: api})
      }
    },
    mounted() {
      // emit('fc_tabs', {
